...
import { TABLE_PRIORITY_ATTR, TABLE_INDEX_ATTR } from '@AwUtils/constants'
import AwTableRowToggler from '@AwOrganisms/AwTable/_AwTableRowToggler.vue'
import AwTableRowHidden from '@AwOrganisms/AwTable/_AwTableRowHidden.vue'
    ...
    render(h, { props }) {
        ...
        return [
            ...
            h(
                'tr',
                {
                    staticClass: 'bg-surface hover:bg-mono-900',
